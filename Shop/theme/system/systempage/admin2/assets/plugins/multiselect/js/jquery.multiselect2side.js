 ...
 * 20121030 zhangshijia 加入属性
 * option 中加入属性 noselect="true"
 * 即不可选择
 */
		...
		init : function(options) {
			...
			return this.each(function () {
				...
				var htmlToAdd = 
					"<div class='ms2side__div'>" +
						...
						"<div class='ms2side__select'>" +
							...
							"<select title='" + o.labelsx + "' name='" + nameSx + "' id='" + nameSx + "' size='" + size + "' multiple='multiple' class='form-control' style='height:200px;'></select>" +
						"</div>" +
						"<div class='ms2side__options'>" +
							((o.selectedPosition == 'right')
							?
							("<button type='button' class='btn btn-default AddOne m-b-5' title='Add Selected'><i class='ti-angle-right'></i></button>" +
							"<button type='button' class='btn btn-default AddAll m-b-5' title='Add All'><i class='ti-angle-double-right'></i></button>" +
							"<button type='button' class='btn btn-default RemoveOne m-b-5' title='Remove Selected'><i class='ti-angle-left'></i></button>" +
							"<button type='button' class='btn btn-default RemoveAll' title='Remove All'><i class='ti-angle-double-left'></i></button>")
							:
							("<button type='button' class='btn btn-default AddOne m-b-5' title='Add Selected'><i class='ti-angle-right'></i></button>" +
							"<button type='button' class='btn btn-default AddAll m-b-5' title='Add All'><i class='ti-angle-double-right'></i></button>" +
							"<button type='button' class='btn btn-default RemoveOne m-b-5' title='Remove Selected'><i class='ti-angle-left'></i></button>" +
						...
						"<div class='ms2side__select'>" +
							...
							"<select title='" + o.labeldx + "' name='" + nameDx + "' id='" + nameDx + "' size='" + size + "' multiple='multiple' class='form-control' style='height:200px;'></select>" +
						"</div>" +
						((o.selectedPosition == 'right' && o.moveOptions) ? divUpDown : "") +
					"</div>";
				...
				allSel.change(function() {
					...
					var	_selectedSx = leftSel.find("option:selected");
					var	_selectedDx = rightSel.find("option:selected");

					if (_selectedSx.size() == 0 ||
							(o.maxSelected >= 0 && (_selectedSx.size() + selectDx.size()) > o.maxSelected))
					...
					if (_selectedDx.size() > 0) {
						div.find(".RemoveOne").removeClass('ms2side__hide');
						// ALL SELECTED - NO MOVE
						if (_selectedDx.size() < selectDx.size()) {	// FOR NOW (JOE) && _selectedDx.size() == 1
							if (_selectedDx.val() != selectDx.val())	// FIRST OPTION, NO UP AND TOP BUTTON
								div.find(".MoveUp, .MoveTop").removeClass('ms2side__hide');
							if (_selectedDx.last().val() != selectDx.last().val())	// LAST OPTION, NO DOWN AND BOTTOM BUTTON
