...
namespace Shop
{
    ...
    public class P_UserLike : ShopPageUser
    {
        ...
        protected override void LoadPage(string themecode, int siteid, string languagecode, string pcode)
        {
            ...
            path = "<a href=\"" + URL("P_Index", "") + "\" class=\"home\" title=\"" + Tag("首页") + "\"><span>" + Tag("首页") + "</span></a><em class=\"home\">&raquo;</em><a href=\"" + URL("P_UserCenter", "") + "\"><span>" + Tag("会员中心") + "</span></a><em>&raquo;</em><a href=\"" + URL("P_UserLike", "") + "\"><span>" + Tag("我的收藏") + "</span></a>";
            key = Rstring("key");
            ...
            where = "User_id=" + CurrentUser.id + " and Type_id_UserProductType=141";
            if (key != "")
