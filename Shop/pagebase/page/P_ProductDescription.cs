...
namespace Shop
{
    public class P_ProductDescription : P_Product
    {
        ...
        protected override void LoadPage(string themecode, int siteid, string languagecode, string pcode)
        {
            ...
            path = "<a href=\"" + URL("P_Index", "") + "\" class=\"home\" title=\"" + Tag(" ◊“≥") + "\"><span>" + Tag(" ◊“≥") + "</span></a><em class=\"home\">&raquo;</em>";
            if (pro_type != null)
            {
            ...
            switch (tag.ToLower())
            {
                ...
                default:
                    if (Lang(theme_page.SEO_Title) == "")
                        str = Tag("œÍœ∏ΩÈ…‹") + " - " + Lang(product.Name);
                    else
