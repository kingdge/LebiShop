...
{
    public partial class part_window : AdminAjaxBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ispage = RequestTool.RequestInt("ispage",0);
        }
        ...
        public string GetList(string folder)
        {
            ...
            try
            {
                ...
                foreach (DirectoryInfo dir in dirs)
                {
                    ...
                    str += "<td><a href=\"?file=" + filename + ";\">" + Tag("打开") + "</a></td>";
                    str += "</tr>";
                }
                ...
                foreach (FileInfo f in files)
                {
                    ...
                    str += "<td><a href=\"javascript:void(0);\" onclick=\"LoadSystemPage('" + filename + "');\">" + Tag("选择") + "</a></td>";
                    str += "</tr>";
                }
            }
            catch (Exception ex)
