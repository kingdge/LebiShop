...
namespace weixinpayh5
{
	...
	public class TenpayUtil
	{
		...
		{
            Lebi_OnlinePay onlinepay = Shop.Bussiness.Money.GetOnlinePay(order, "weixinpayh5");  //B_Lebi_OnlinePay.GetModel("id = " + order.OnlinePay_id + "");
            if (onlinepay == null)
            {
            ...
            tenpay_notify = "http://" + RequestTool.GetRequestDomain() + site.WebPath + "/onlinepay/weixinpayh5/payNotifyUrl.aspx";
		}
