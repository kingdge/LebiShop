...
namespace DB.LebiShop
{
	...
	/// 数据访问类D_Lebi_Comment。
	/// </summary>
	public partial class D_Lebi_Comment
	{
		static D_Lebi_Comment _Instance;
		public static D_Lebi_Comment Instance
		{
		   get
		   {
		        if (_Instance == null)
		        {
		            _Instance = new D_Lebi_Comment("Lebi_Comment");
		        }
		        return _Instance;
		    }
		    set
		...
		string TableName = "Lebi_Comment";
		public D_Lebi_Comment(string tablename)
		{
		    TableName = tablename;
		}
		...
		public string GetValue(string colName,string strWhere,int seconds=0)
		{
		   ...
		   try
		   {
		       ...
		       if (cachekey != "")
		           LB.DataAccess.DB.Instance.SetMemchche(cachekey, val, "Lebi_Comment", 0 , cachestr , seconds);
		   }
		   catch
		   {
		       val = "";
		...
		public int Add(Lebi_Comment model)
		{
			...
			strSql.Append(LB.DataAccess.DB.BaseUtilsInstance.ColName("Admin_id")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Admin_UserName")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Content")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Images")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("ImagesSmall")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("IsRead")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Keyid")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Language_Code")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Parentid")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Product_id")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Star")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Status")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Supplier_id")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Supplier_SubName")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("TableName")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Time_Add")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("User_id")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("User_UserName")+")");
			strSql.Append(" values (");
			strSql.Append("@Admin_id,@Admin_UserName,@Content,@Images,@ImagesSmall,@IsRead,@Keyid,@Language_Code,@Parentid,@Product_id,@Star,@Status,@Supplier_id,@Supplier_SubName,@TableName,@Time_Add,@User_id,@User_UserName);select @@identity;");
		...
		public void Update(Lebi_Comment model)
		{
			...
			if((","+model.UpdateCols+",").IndexOf(",ImagesSmall,")>-1 || model.UpdateCols=="")
			   cols.Add(LB.DataAccess.DB.BaseUtilsInstance.ColName("ImagesSmall")+"= @ImagesSmall");
			...
			if((","+model.UpdateCols+",").IndexOf(",Star,")>-1 || model.UpdateCols=="")
			   cols.Add(LB.DataAccess.DB.BaseUtilsInstance.ColName("Star")+"= @Star");
		...
		/// 得到一个对象实体 by id
		/// </summary>
		public Lebi_Comment GetModel(int id, int seconds=0)
		{
		   ...
		   if (BaseUtils.BaseUtilsInstance.MemcacheInstance != null && seconds > 0)
		   {
		       ...
		       var obj = LB.DataAccess.DB.Instance.GetMemchche(cachekey);
		       if (obj != null)
		           return obj as Lebi_Comment;
		   }
		   Lebi_Comment model = null;
		   using (IDataReader dataReader = LB.DataAccess.DB.Instance.TextExecuteReaderOne(strTableName, strFieldShow,  strWhere, null))
		   {
		       ...
		       while (dataReader.Read())
		       {
		           ...
		           if (cachekey != "")
		               LB.DataAccess.DB.Instance.SetMemchche(cachekey, model, "Lebi_Comment",id , cachestr , seconds);
		           return model;
		       }
		   }
		   return null;
		...
		/// 得到一个对象实体 by where条件
		/// </summary>
		public Lebi_Comment GetModel(string strWhere, int seconds=0)
		{
		   if (strWhere.IndexOf("lbsql{") > 0)
		   {
		       SQLPara para = new SQLPara(strWhere, "", "");
		   ...
		   using (IDataReader dataReader = LB.DataAccess.DB.Instance.TextExecuteReaderOne(strTableName, strFieldShow, strWhere, null))
		   {
		       ...
		       while (dataReader.Read())
		       {
		           model = ReaderBind(dataReader);
		           if (cachekey != "")
		               LB.DataAccess.DB.Instance.SetMemchche(cachekey, model, "Lebi_Comment",model.id , cachestr , seconds);
		           return model;
		       }
		   }
		   return null;
		...
		/// 得到一个对象实体 by SQLpara
		/// </summary>
		public Lebi_Comment GetModel(SQLPara para, int seconds=0)
		{
		   string strTableName = TableName;
		   string strFieldShow = "*";
		...
		/// 获得数据列表-带分页
		/// </summary>
		public List<Lebi_Comment> GetList(string strWhere, string strFieldOrder, int PageSize, int page, int seconds=0)
		{
		   if (strWhere.IndexOf("lbsql{") > 0)
		   {
		   ...
		   if (BaseUtils.BaseUtilsInstance.MemcacheInstance != null && seconds > 0)
		   {
		       ...
		       var obj = LB.DataAccess.DB.Instance.GetMemchche(cachekey);
		       if (obj != null)
		           return obj as List<Lebi_Comment>;
		   }
		   ...
		   if (cachekey != "" && list.Count > 0)
		         LB.DataAccess.DB.Instance.SetMemchche(cachekey, list, "Lebi_Comment", 0 , cachestr , seconds);
		   return list;
		}
		public List<Lebi_Comment> GetList(SQLPara para, int PageSize, int page, int seconds=0)
		{
		   string strTableName = TableName;
		   string strFieldKey = "id";
		   string strFieldShow = "*";
		...
		/// 获得数据列表-不带分页
		/// </summary>
		public List<Lebi_Comment> GetList(string strWhere,string strFieldOrder, int seconds=0)
		{
		   if (strWhere.IndexOf("lbsql{") > 0)
		   {
		       SQLPara para = new SQLPara(strWhere, strFieldOrder, "");
		...
		public List<Lebi_Comment> GetList(SQLPara para, int seconds=0)
		{
		   string strTableName = TableName;
		   StringBuilder strSql=new StringBuilder();
		...
		public Lebi_Comment BindForm(Lebi_Comment model)
		{
			...
			if (HttpContext.Current.Request["ImagesSmall"] != null)
				model.ImagesSmall=LB.Tools.RequestTool.RequestString("ImagesSmall");
			...
			if (HttpContext.Current.Request["Star"] != null)
				model.Star=LB.Tools.RequestTool.RequestInt("Star",0);
		...
		public Lebi_Comment SafeBindForm(Lebi_Comment model)
		{
			...
			if (HttpContext.Current.Request["ImagesSmall"] != null)
				model.ImagesSmall=LB.Tools.RequestTool.RequestSafeString("ImagesSmall");
			if (HttpContext.Current.Request["IsRead"] != null)
				model.IsRead=LB.Tools.RequestTool.RequestInt("IsRead",0);
			if (HttpContext.Current.Request["Keyid"] != null)
				model.Keyid=LB.Tools.RequestTool.RequestInt("Keyid",0);
		...
		public Lebi_Comment ReaderBind(IDataReader dataReader)
		{
			...
			if(ojb != null && ojb != DBNull.Value)
			{
				model.Star= Convert.ToInt32(ojb);
			}
