...
namespace DB.LebiShop
{
	...
	/// </summary>
	public partial class D_Lebi_Order_ProPerty
	{
		static D_Lebi_Order_ProPerty _Instance;
		public static D_Lebi_Order_ProPerty Instance
		{
		   get
		   {
		        if (_Instance == null)
		        {
		            _Instance = new D_Lebi_Order_ProPerty("Lebi_Order_ProPerty");
		        }
		        return _Instance;
		    }
		    set
		...
		string TableName = "Lebi_Order_ProPerty";
		public D_Lebi_Order_ProPerty(string tablename)
		{
		    TableName = tablename;
		}
		...
		public string GetValue(string colName,string strWhere,int seconds=0)
		{
		   ...
		   try
		   {
		       ...
		       if (cachekey != "")
		           LB.DataAccess.DB.Instance.SetMemchche(cachekey, val, "Lebi_Order_ProPerty", 0 , cachestr , seconds);
		   }
		   catch
		   {
		       val = "";
		...
		public int Add(Lebi_Order_ProPerty model)
		{
			...
			strSql.Append(LB.DataAccess.DB.BaseUtilsInstance.ColName("Order_Code")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Order_id")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("ProPertyid")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("ProPertyName")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("ProPertyParentid")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("ProPertyValue")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Time_Add")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("User_id")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("User_UserName")+")");
			strSql.Append(" values (");
			strSql.Append("@Order_Code,@Order_id,@ProPertyid,@ProPertyName,@ProPertyParentid,@ProPertyValue,@Time_Add,@User_id,@User_UserName);select @@identity;");
		...
		public void Update(Lebi_Order_ProPerty model)
		{
			...
			if((","+model.UpdateCols+",").IndexOf(",ProPertyid,")>-1 || model.UpdateCols=="")
			   cols.Add(LB.DataAccess.DB.BaseUtilsInstance.ColName("ProPertyid")+"= @ProPertyid");
			if((","+model.UpdateCols+",").IndexOf(",ProPertyName,")>-1 || model.UpdateCols=="")
			   cols.Add(LB.DataAccess.DB.BaseUtilsInstance.ColName("ProPertyName")+"= @ProPertyName");
			if((","+model.UpdateCols+",").IndexOf(",ProPertyParentid,")>-1 || model.UpdateCols=="")
			   cols.Add(LB.DataAccess.DB.BaseUtilsInstance.ColName("ProPertyParentid")+"= @ProPertyParentid");
			if((","+model.UpdateCols+",").IndexOf(",ProPertyValue,")>-1 || model.UpdateCols=="")
			   cols.Add(LB.DataAccess.DB.BaseUtilsInstance.ColName("ProPertyValue")+"= @ProPertyValue");
		...
		/// 得到一个对象实体 by id
		/// </summary>
		public Lebi_Order_ProPerty GetModel(int id, int seconds=0)
		{
		   ...
		   if (BaseUtils.BaseUtilsInstance.MemcacheInstance != null && seconds > 0)
		   {
		       ...
		       var obj = LB.DataAccess.DB.Instance.GetMemchche(cachekey);
		       if (obj != null)
		           return obj as Lebi_Order_ProPerty;
		   }
		   Lebi_Order_ProPerty model = null;
		   using (IDataReader dataReader = LB.DataAccess.DB.Instance.TextExecuteReaderOne(strTableName, strFieldShow,  strWhere, null))
		   {
		       ...
		       while (dataReader.Read())
		       {
		           ...
		           if (cachekey != "")
		               LB.DataAccess.DB.Instance.SetMemchche(cachekey, model, "Lebi_Order_ProPerty",id , cachestr , seconds);
		           return model;
		       }
		   }
		   return null;
		...
		/// 得到一个对象实体 by where条件
		/// </summary>
		public Lebi_Order_ProPerty GetModel(string strWhere, int seconds=0)
		{
		   if (strWhere.IndexOf("lbsql{") > 0)
		   {
		       SQLPara para = new SQLPara(strWhere, "", "");
		   ...
		   using (IDataReader dataReader = LB.DataAccess.DB.Instance.TextExecuteReaderOne(strTableName, strFieldShow, strWhere, null))
		   {
		       ...
		       while (dataReader.Read())
		       {
		           model = ReaderBind(dataReader);
		           if (cachekey != "")
		               LB.DataAccess.DB.Instance.SetMemchche(cachekey, model, "Lebi_Order_ProPerty",model.id , cachestr , seconds);
		           return model;
		       }
		   }
		   return null;
		...
		/// 得到一个对象实体 by SQLpara
		/// </summary>
		public Lebi_Order_ProPerty GetModel(SQLPara para, int seconds=0)
		{
		   string strTableName = TableName;
		   string strFieldShow = "*";
		...
		/// 获得数据列表-带分页
		/// </summary>
		public List<Lebi_Order_ProPerty> GetList(string strWhere, string strFieldOrder, int PageSize, int page, int seconds=0)
		{
		   if (strWhere.IndexOf("lbsql{") > 0)
		   {
		   ...
		   if (BaseUtils.BaseUtilsInstance.MemcacheInstance != null && seconds > 0)
		   {
		       ...
		       var obj = LB.DataAccess.DB.Instance.GetMemchche(cachekey);
		       if (obj != null)
		           return obj as List<Lebi_Order_ProPerty>;
		   }
		   ...
		   if (cachekey != "" && list.Count > 0)
		         LB.DataAccess.DB.Instance.SetMemchche(cachekey, list, "Lebi_Order_ProPerty", 0 , cachestr , seconds);
		   return list;
		}
		public List<Lebi_Order_ProPerty> GetList(SQLPara para, int PageSize, int page, int seconds=0)
		{
		   string strTableName = TableName;
		   string strFieldKey = "id";
		   string strFieldShow = "*";
		...
		/// 获得数据列表-不带分页
		/// </summary>
		public List<Lebi_Order_ProPerty> GetList(string strWhere,string strFieldOrder, int seconds=0)
		{
		   if (strWhere.IndexOf("lbsql{") > 0)
		   {
		       SQLPara para = new SQLPara(strWhere, strFieldOrder, "");
		...
		public List<Lebi_Order_ProPerty> GetList(SQLPara para, int seconds=0)
		{
		   string strTableName = TableName;
		   StringBuilder strSql=new StringBuilder();
		...
		public Lebi_Order_ProPerty BindForm(Lebi_Order_ProPerty model)
		{
			...
			if (HttpContext.Current.Request["ProPertyid"] != null)
				model.ProPertyid=LB.Tools.RequestTool.RequestInt("ProPertyid",0);
			if (HttpContext.Current.Request["ProPertyName"] != null)
				model.ProPertyName=LB.Tools.RequestTool.RequestString("ProPertyName");
			if (HttpContext.Current.Request["ProPertyParentid"] != null)
				model.ProPertyParentid=LB.Tools.RequestTool.RequestInt("ProPertyParentid",0);
			if (HttpContext.Current.Request["ProPertyValue"] != null)
				model.ProPertyValue=LB.Tools.RequestTool.RequestString("ProPertyValue");
		...
		public Lebi_Order_ProPerty SafeBindForm(Lebi_Order_ProPerty model)
		{
			...
			if (HttpContext.Current.Request["ProPertyid"] != null)
				model.ProPertyid=LB.Tools.RequestTool.RequestInt("ProPertyid",0);
			if (HttpContext.Current.Request["ProPertyName"] != null)
				model.ProPertyName=LB.Tools.RequestTool.RequestSafeString("ProPertyName");
			if (HttpContext.Current.Request["ProPertyParentid"] != null)
				model.ProPertyParentid=LB.Tools.RequestTool.RequestInt("ProPertyParentid",0);
			if (HttpContext.Current.Request["ProPertyValue"] != null)
				model.ProPertyValue=LB.Tools.RequestTool.RequestSafeString("ProPertyValue");
			if (HttpContext.Current.Request["Time_Add"] != null)
				model.Time_Add=LB.Tools.RequestTool.RequestTime("Time_Add", System.DateTime.Now);
			if (HttpContext.Current.Request["User_id"] != null)
				model.User_id=LB.Tools.RequestTool.RequestInt("User_id",0);
