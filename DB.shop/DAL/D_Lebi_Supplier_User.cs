...
namespace DB.LebiShop
{
	...
	/// </summary>
	public partial class D_Lebi_Supplier_User
	{
		static D_Lebi_Supplier_User _Instance;
		public static D_Lebi_Supplier_User Instance
		{
		   get
		   {
		        if (_Instance == null)
		        {
		            _Instance = new D_Lebi_Supplier_User("Lebi_Supplier_User");
		        }
		        return _Instance;
		    }
		    set
		...
		string TableName = "Lebi_Supplier_User";
		public D_Lebi_Supplier_User(string tablename)
		{
		    TableName = tablename;
		}
		...
		public string GetValue(string colName,string strWhere,int seconds=0)
		{
		   ...
		   try
		   {
		       ...
		       if (cachekey != "")
		           LB.DataAccess.DB.Instance.SetMemchche(cachekey, val, "Lebi_Supplier_User", 0 , cachestr , seconds);
		   }
		   catch
		   {
		       val = "";
		...
		public int Add(Lebi_Supplier_User model)
		{
			...
			strSql.Append(LB.DataAccess.DB.BaseUtilsInstance.ColName("Remark")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("RemarkName")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Supplier_id")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Supplier_UserGroup_id")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Time_Add")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Type_id_SupplierUserStatus")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("User_id")+")");
			strSql.Append(" values (");
			strSql.Append("@Remark,@RemarkName,@Supplier_id,@Supplier_UserGroup_id,@Time_Add,@Type_id_SupplierUserStatus,@User_id);select @@identity;");
		...
		public void Update(Lebi_Supplier_User model)
		{
			...
			if((","+model.UpdateCols+",").IndexOf(",RemarkName,")>-1 || model.UpdateCols=="")
			   cols.Add(LB.DataAccess.DB.BaseUtilsInstance.ColName("RemarkName")+"= @RemarkName");
			...
			if((","+model.UpdateCols+",").IndexOf(",Supplier_UserGroup_id,")>-1 || model.UpdateCols=="")
			   cols.Add(LB.DataAccess.DB.BaseUtilsInstance.ColName("Supplier_UserGroup_id")+"= @Supplier_UserGroup_id");
			...
			if((","+model.UpdateCols+",").IndexOf(",Type_id_SupplierUserStatus,")>-1 || model.UpdateCols=="")
			   cols.Add(LB.DataAccess.DB.BaseUtilsInstance.ColName("Type_id_SupplierUserStatus")+"= @Type_id_SupplierUserStatus");
		...
		/// 得到一个对象实体 by id
		/// </summary>
		public Lebi_Supplier_User GetModel(int id, int seconds=0)
		{
		   ...
		   if (BaseUtils.BaseUtilsInstance.MemcacheInstance != null && seconds > 0)
		   {
		       ...
		       var obj = LB.DataAccess.DB.Instance.GetMemchche(cachekey);
		       if (obj != null)
		           return obj as Lebi_Supplier_User;
		   }
		   ...
		   using (IDataReader dataReader = LB.DataAccess.DB.Instance.TextExecuteReaderOne(strTableName, strFieldShow,  strWhere, null))
		   {
		       ...
		       while (dataReader.Read())
		       {
		           ...
		           if (cachekey != "")
		               LB.DataAccess.DB.Instance.SetMemchche(cachekey, model, "Lebi_Supplier_User",id , cachestr , seconds);
		           return model;
		       }
		   }
		   return null;
		...
		/// 得到一个对象实体 by where条件
		/// </summary>
		public Lebi_Supplier_User GetModel(string strWhere, int seconds=0)
		{
		   if (strWhere.IndexOf("lbsql{") > 0)
		   {
		       SQLPara para = new SQLPara(strWhere, "", "");
		   ...
		   using (IDataReader dataReader = LB.DataAccess.DB.Instance.TextExecuteReaderOne(strTableName, strFieldShow, strWhere, null))
		   {
		       ...
		       while (dataReader.Read())
		       {
		           model = ReaderBind(dataReader);
		           if (cachekey != "")
		               LB.DataAccess.DB.Instance.SetMemchche(cachekey, model, "Lebi_Supplier_User",model.id , cachestr , seconds);
		           return model;
		       }
		   }
		   return null;
		...
		/// 得到一个对象实体 by SQLpara
		/// </summary>
		public Lebi_Supplier_User GetModel(SQLPara para, int seconds=0)
		{
		   string strTableName = TableName;
		   string strFieldShow = "*";
		...
		/// 获得数据列表-带分页
		/// </summary>
		public List<Lebi_Supplier_User> GetList(string strWhere, string strFieldOrder, int PageSize, int page, int seconds=0)
		{
		   if (strWhere.IndexOf("lbsql{") > 0)
		   {
		   ...
		   if (BaseUtils.BaseUtilsInstance.MemcacheInstance != null && seconds > 0)
		   {
		       ...
		       var obj = LB.DataAccess.DB.Instance.GetMemchche(cachekey);
		       if (obj != null)
		           return obj as List<Lebi_Supplier_User>;
		   }
		   ...
		   if (cachekey != "" && list.Count > 0)
		         LB.DataAccess.DB.Instance.SetMemchche(cachekey, list, "Lebi_Supplier_User", 0 , cachestr , seconds);
		   return list;
		}
		public List<Lebi_Supplier_User> GetList(SQLPara para, int PageSize, int page, int seconds=0)
		{
		   string strTableName = TableName;
		   string strFieldKey = "id";
		   string strFieldShow = "*";
		...
		/// 获得数据列表-不带分页
		/// </summary>
		public List<Lebi_Supplier_User> GetList(string strWhere,string strFieldOrder, int seconds=0)
		{
		   if (strWhere.IndexOf("lbsql{") > 0)
		   {
		       SQLPara para = new SQLPara(strWhere, strFieldOrder, "");
		...
		public List<Lebi_Supplier_User> GetList(SQLPara para, int seconds=0)
		{
		   string strTableName = TableName;
		   StringBuilder strSql=new StringBuilder();
		...
		public Lebi_Supplier_User BindForm(Lebi_Supplier_User model)
		{
			...
			if (HttpContext.Current.Request["RemarkName"] != null)
				model.RemarkName=LB.Tools.RequestTool.RequestString("RemarkName");
			...
			if (HttpContext.Current.Request["Supplier_UserGroup_id"] != null)
				model.Supplier_UserGroup_id=LB.Tools.RequestTool.RequestInt("Supplier_UserGroup_id",0);
			...
			if (HttpContext.Current.Request["Type_id_SupplierUserStatus"] != null)
				model.Type_id_SupplierUserStatus=LB.Tools.RequestTool.RequestInt("Type_id_SupplierUserStatus",0);
		...
		public Lebi_Supplier_User SafeBindForm(Lebi_Supplier_User model)
		{
			...
			if (HttpContext.Current.Request["RemarkName"] != null)
				model.RemarkName=LB.Tools.RequestTool.RequestSafeString("RemarkName");
			if (HttpContext.Current.Request["Supplier_id"] != null)
				model.Supplier_id=LB.Tools.RequestTool.RequestInt("Supplier_id",0);
			if (HttpContext.Current.Request["Supplier_UserGroup_id"] != null)
				model.Supplier_UserGroup_id=LB.Tools.RequestTool.RequestInt("Supplier_UserGroup_id",0);
		...
		public Lebi_Supplier_User ReaderBind(IDataReader dataReader)
		{
			...
			if(ojb != null && ojb != DBNull.Value)
			{
				model.Supplier_UserGroup_id= Convert.ToInt32(ojb);
			}
			...
			if(ojb != null && ojb != DBNull.Value)
			{
				model.Type_id_SupplierUserStatus= Convert.ToInt32(ojb);
			}
