...
namespace DB.LebiShop
{
	...
	/// 数据访问类D_Lebi_Express。
	/// </summary>
	public partial class D_Lebi_Express
	{
		static D_Lebi_Express _Instance;
		public static D_Lebi_Express Instance
		{
		   get
		   {
		        if (_Instance == null)
		        {
		            _Instance = new D_Lebi_Express("Lebi_Express");
		        }
		        return _Instance;
		    }
		    set
		...
		string TableName = "Lebi_Express";
		public D_Lebi_Express(string tablename)
		{
		    TableName = tablename;
		}
		...
		public string GetValue(string colName,string strWhere,int seconds=0)
		{
		   ...
		   try
		   {
		       ...
		       if (cachekey != "")
		           LB.DataAccess.DB.Instance.SetMemchche(cachekey, val, "Lebi_Express", 0 , cachestr , seconds);
		   }
		   catch
		   {
		       val = "";
		...
		public int Add(Lebi_Express model)
		{
			...
			strSql.Append(LB.DataAccess.DB.BaseUtilsInstance.ColName("Background")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Height")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Name")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Pos")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Sort")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Status")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Transport_id")+","+LB.DataAccess.DB.BaseUtilsInstance.ColName("Width")+")");
			strSql.Append(" values (");
			strSql.Append("@Background,@Height,@Name,@Pos,@Sort,@Status,@Transport_id,@Width);select @@identity;");
		...
		public void Update(Lebi_Express model)
		{
			...
			if((","+model.UpdateCols+",").IndexOf(",Background,")>-1 || model.UpdateCols=="")
			   cols.Add(LB.DataAccess.DB.BaseUtilsInstance.ColName("Background")+"= @Background");
			...
			if((","+model.UpdateCols+",").IndexOf(",Pos,")>-1 || model.UpdateCols=="")
			   cols.Add(LB.DataAccess.DB.BaseUtilsInstance.ColName("Pos")+"= @Pos");
		...
		/// 得到一个对象实体 by id
		/// </summary>
		public Lebi_Express GetModel(int id, int seconds=0)
		{
		   ...
		   if (BaseUtils.BaseUtilsInstance.MemcacheInstance != null && seconds > 0)
		   {
		       ...
		       var obj = LB.DataAccess.DB.Instance.GetMemchche(cachekey);
		       if (obj != null)
		           return obj as Lebi_Express;
		   }
		   Lebi_Express model = null;
		   using (IDataReader dataReader = LB.DataAccess.DB.Instance.TextExecuteReaderOne(strTableName, strFieldShow,  strWhere, null))
		   {
		       ...
		       while (dataReader.Read())
		       {
		           ...
		           if (cachekey != "")
		               LB.DataAccess.DB.Instance.SetMemchche(cachekey, model, "Lebi_Express",id , cachestr , seconds);
		           return model;
		       }
		   }
		   return null;
		...
		/// 得到一个对象实体 by where条件
		/// </summary>
		public Lebi_Express GetModel(string strWhere, int seconds=0)
		{
		   if (strWhere.IndexOf("lbsql{") > 0)
		   {
		       SQLPara para = new SQLPara(strWhere, "", "");
		   ...
		   using (IDataReader dataReader = LB.DataAccess.DB.Instance.TextExecuteReaderOne(strTableName, strFieldShow, strWhere, null))
		   {
		       ...
		       while (dataReader.Read())
		       {
		           model = ReaderBind(dataReader);
		           if (cachekey != "")
		               LB.DataAccess.DB.Instance.SetMemchche(cachekey, model, "Lebi_Express",model.id , cachestr , seconds);
		           return model;
		       }
		   }
		   return null;
		...
		/// 得到一个对象实体 by SQLpara
		/// </summary>
		public Lebi_Express GetModel(SQLPara para, int seconds=0)
		{
		   string strTableName = TableName;
		   string strFieldShow = "*";
		...
		/// 获得数据列表-带分页
		/// </summary>
		public List<Lebi_Express> GetList(string strWhere, string strFieldOrder, int PageSize, int page, int seconds=0)
		{
		   if (strWhere.IndexOf("lbsql{") > 0)
		   {
		   ...
		   if (BaseUtils.BaseUtilsInstance.MemcacheInstance != null && seconds > 0)
		   {
		       ...
		       var obj = LB.DataAccess.DB.Instance.GetMemchche(cachekey);
		       if (obj != null)
		           return obj as List<Lebi_Express>;
		   }
		   ...
		   if (cachekey != "" && list.Count > 0)
		         LB.DataAccess.DB.Instance.SetMemchche(cachekey, list, "Lebi_Express", 0 , cachestr , seconds);
		   return list;
		}
		public List<Lebi_Express> GetList(SQLPara para, int PageSize, int page, int seconds=0)
		{
		   string strTableName = TableName;
		   string strFieldKey = "id";
		   string strFieldShow = "*";
		...
		/// 获得数据列表-不带分页
		/// </summary>
		public List<Lebi_Express> GetList(string strWhere,string strFieldOrder, int seconds=0)
		{
		   if (strWhere.IndexOf("lbsql{") > 0)
		   {
		       SQLPara para = new SQLPara(strWhere, strFieldOrder, "");
		...
		public List<Lebi_Express> GetList(SQLPara para, int seconds=0)
		{
		   string strTableName = TableName;
		   StringBuilder strSql=new StringBuilder();
		...
		public Lebi_Express BindForm(Lebi_Express model)
		{
			if (HttpContext.Current.Request["Background"] != null)
				model.Background=LB.Tools.RequestTool.RequestString("Background");
			if (HttpContext.Current.Request["Height"] != null)
				model.Height=LB.Tools.RequestTool.RequestString("Height");
			if (HttpContext.Current.Request["Name"] != null)
				model.Name=LB.Tools.RequestTool.RequestString("Name");
			if (HttpContext.Current.Request["Pos"] != null)
				model.Pos=LB.Tools.RequestTool.RequestString("Pos");
			...
			if (HttpContext.Current.Request["Width"] != null)
				model.Width=LB.Tools.RequestTool.RequestString("Width");
				return model;
		}
		/// <summary>
		/// 安全方式绑定对象表单
		...
		{
			if (HttpContext.Current.Request["Background"] != null)
				model.Background=LB.Tools.RequestTool.RequestSafeString("Background");
			if (HttpContext.Current.Request["Height"] != null)
				model.Height=LB.Tools.RequestTool.RequestSafeString("Height");
			if (HttpContext.Current.Request["Name"] != null)
				model.Name=LB.Tools.RequestTool.RequestSafeString("Name");
			if (HttpContext.Current.Request["Pos"] != null)
				model.Pos=LB.Tools.RequestTool.RequestSafeString("Pos");
			if (HttpContext.Current.Request["Sort"] != null)
				model.Sort=LB.Tools.RequestTool.RequestInt("Sort",0);
			if (HttpContext.Current.Request["Status"] != null)
				model.Status=LB.Tools.RequestTool.RequestInt("Status",0);
			if (HttpContext.Current.Request["Transport_id"] != null)
				model.Transport_id=LB.Tools.RequestTool.RequestInt("Transport_id",0);
			if (HttpContext.Current.Request["Width"] != null)
				model.Width=LB.Tools.RequestTool.RequestSafeString("Width");
				return model;
		}
