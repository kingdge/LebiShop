...
namespace LB.Tools
{
    ...
    public class Utils
    {
        ...
        {
            return TypeParseHelper.StrToBool(expression, defValue);
        }
        ...
        {
            return TypeParseHelper.StrToInt(expression, defValue);
        }
        ...
        {
            return TypeParseHelper.StrToFloat(strValue, defValue);
        }
        ...
        /// <returns></returns>
        public static string GetImageSize(string originalImagePath, int width, int height)
        {
            string Msg = "";
            int towidth = 0;
            int toheight = 0;
            int ow = 0;
            int oh = 0;
            string treePath = System.Web.HttpContext.Current.Server.MapPath("/");
            System.Drawing.Image originalImage;
            try
            {
                originalImage = System.Drawing.Image.FromFile(treePath + originalImagePath);
                ...
                Msg = "width=" + towidth + " height=" + toheight + "";
            }
            catch
            {
                Msg = "width=" + ow + " height=" + oh + "";
            }
