...
namespace LB.Tools
{
    ...
    public class PinYinConverter
    {
        ...
        private static string[] otherChinese = new string[]
        {
            ...
            ,"黟","黢","黩","黧","黥","黪","黯","鼢","鼬","鼯","鼹","鼷","鼽","鼾","齄","瀞"
            ,"姵","喆","瑀","嫚","琄","嬿","瑀","暎","嫀","劼","畊","渟","瑄","旻","赟","靳"
        };
        ...
        private static string[] otherPinYin = new string[]
           {
               "Chu","Ji","Wu","Gai","Nian","Sa","Pi","Gen","Cheng","Ge","Nao","E","Shu","Yu","Pie","Bi",
                ...
                "Xia","Yi","Qu","Du","Li","Qing","Can","An","Fen","You","Wu","Yan","Xi","Qiu","Han","Zha","Jing",
                "Pei","Zhe","Yu","Man","Xuan","Yan","Yu","Ying","Shen","Jie","Geng","Ting","Xuan","Min","Yun","Jin"
           };
        #endregion 二级汉字
        #region 变量定义
