...
namespace Shop.Model
{
    ...
    public class BaseConfig
    {
        ...
        /// 订单付款
        /// </summary>
        public string EmailTPL_orderpaid { get; set; }
        /// <summary>
        /// 邮件模板
        /// 订单发货
        /// </summary>
        ...
        /// 订单付款
        /// </summary>
        public string EmailTPL_orderpaid_title { get; set; }
        /// <summary>
        /// 邮件模板-标题
        /// 订单发货
        /// </summary>
        ...
        /// 订单付款
        /// </summary>
        public string EmailTPL_Admin_orderpaid { get; set; }
        /// <summary>
        /// 邮件模板-管理员
        /// 订单留言
        /// </summary>
        ...
        /// 订单付款
        /// </summary>
        public string EmailTPL_Admin_orderpaid_title { get; set; }
        /// <summary>
        /// 邮件模板-管理员-标题
        /// 订单留言
        /// </summary>
        ...
        /// 减少购物车步骤
        /// </summary>
        public string IsReduceBasketStep { get; set; }
        /// <summary>
        /// 0库存自动下架
        /// </summary>
        ...
        /// 三级会员佣金比例
        /// </summary>
        public string Angent3_Commission { get; set; }
        /// <summary>
        /// 会员佣金比例
        /// </summary>
        ...
        /// 推送开关
        /// </summary>
        public string APPPush_state { get; set; }
        /// <summary>
        /// 推送类型
        /// </summary>
        public string APPPush_sendmode { get; set; }
        /// <summary>
        /// APP分享配置
        /// </summary>
        public string app_share { get; set; }
        /// <summary>
        /// APP分享微信配置
        /// </summary>
        public string app_share_wechat_key { get; set; }
        public string app_share_wechat_secret { get; set; }
        /// <summary>
        /// APP分享QQ配置
        /// </summary>
        public string app_share_qq_key { get; set; }
        public string app_share_qq_secret { get; set; }
        /// <summary>
        /// APP分享钉钉配置
        /// </summary>
        public string app_share_dingtalk_key { get; set; }
        public string app_share_dingtalk_secret { get; set; }
        #endregion
        #region 面板
        /// <summary>
        /// 管理首页LOGO
        /// </summary>
        public string system_layout_logo { get; set; }
        /// <summary>
        /// 管理登录LOGO
        /// </summary>
        public string system_login_logo { get; set; }
        /// <summary>
        /// 管理登录背景图片
        /// </summary>
        public string system_login_background { get; set; }
        #endregion
    }
    public class BaseConfigStepR
    {

        public BaseConfigStepR() { }
    ...
    /// APP菜单
    /// </summary>
    public class BaseConfigAppMenu
    {
        public string Name { set; get; }
        public string URL { set; get; }
        public string Icon { set; get; }
        public int Sort { set; get; }
        public List<BaseConfigAppMenuSon> Son { set; get; }

    }
    public class BaseConfigAppMenuSon
    {
        public string Name { set; get; }
        public string URL { set; get; }
        public int Sort { set; get; }
