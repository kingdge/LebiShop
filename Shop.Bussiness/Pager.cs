    ...
    public class Pager
    {
        ...
        public static string GetPaginationStringForJS(string pageUrlFormat, int page, int pageSize, int pageTotalItemSize)
        {
            ...
            if (!string.IsNullOrEmpty(RequestTool.GetConfigKey("SystemAdmin").Trim()))
            {
                ...
                if (page <= 1)
                {
                    builder.Append("<li class=\"page-item disabled\"><a class=\"page-link\" href=\"#\" aria-label=\"Previous\" title=\"" + Language.Tag("上一页", lang) + "\">«</a></li>");
                }
                else
                {
                    builder.Append("<li class=\"page-item\"><a class=\"page-link\" href=\"javascript:void(0)\" onclick=\"" + string.Format(pageUrlFormat, (page - 1).ToString()) + "\" aria-label=\"Previous\" title=\"" + Language.Tag("上一页", lang) + "\">«</a></li>");
                }
                ...
                if (pageTotalCount < 11)
                {
                    for (i = 1; i <= pageTotalCount; i++)
                    {
                        ...
                        {
                            builder.Append("<li class=\"page-item\"><a class=\"page-link\" href=\"javascript:void(0)\" onclick=\"" + string.Format(pageUrlFormat, i.ToString()) + "\">" + i.ToString() + "</a></li>");
                        }
                    }
                }
                else
                {
                    if (page < 5)
                    {
                        ...
                        {
                            builder.Append("<li class=\"page-item\"><a class=\"page-link\" href=\"javascript:void(0)\" onclick=\"" + string.Format(pageUrlFormat, (pageTotalCount - 2).ToString()) + "\">" + (pageTotalCount - 2).ToString() + "</a></li>");
                        }
                        ...
                        {
                            builder.Append("<li class=\"page-item\"><a class=\"page-link\" href=\"javascript:void(0)\" onclick=\"" + string.Format(pageUrlFormat, (pageTotalCount - 1).ToString()) + "\">" + (pageTotalCount - 1).ToString() + "</a></li>");
                        }
                        if (page == pageTotalCount)
                        {
                            builder.Append(string.Format("<li class=\"page-item active\"><a class=\"page-link\" href=\"#\">{0}</a></li>", page));
                        ...
                        {
                            builder.Append("<li class=\"page-item\"><a class=\"page-link\" href=\"javascript:void(0)\" onclick=\"" + string.Format(pageUrlFormat, (pageTotalCount).ToString()) + "\">" + (pageTotalCount).ToString() + "</a></li>");
                        }

                    }
                    else
                    {
                        builder.Append("<li class=\"page-item\"><a class=\"page-link\" href=\"javascript:void(0)\" onclick=\"" + string.Format(pageUrlFormat, "1") + "\">1</a></li>");
                        builder.Append("<li class=\"page-item\"><a class=\"page-link\" href=\"javascript:void(0)\" onclick=\"" + string.Format(pageUrlFormat, "2") + "\">2</a></li>");
                        builder.Append("<li class=\"page-item\"><a class=\"page-link\" href=\"#\">...</a></li>");
                        if (page > (pageTotalCount - 7))
                        {
                ...
                if (page < pageTotalCount)
                {
                    builder.Append("<li class=\"page-item\"><a class=\"page-link\" href=\"javascript:void(0)\" onclick=\"" + string.Format(pageUrlFormat, Convert.ToString(page + 1)) + "\" aria-label=\"Next\" title=\"" + Language.Tag("下一页", lang) + "\">»</a></li>");
                }
                else if (page == pageTotalCount)
                {
                    builder.Append("<li class=\"page-item disabled\"><a class=\"page-link\" aria-label=\"Next\" title=\"" + Language.Tag("下一页", lang) + "\">»</a></li>");
                }
                builder.Append("</ul>");
            }
            else
