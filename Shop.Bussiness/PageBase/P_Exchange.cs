...
namespace Shop.Bussiness
{
    ...
    public class P_Exchange : ShopPage
    {
        ...
        protected override void LoadPage(string themecode, int siteid, string languagecode, string pcode)
        {
            ...
            where = "Type_id_ProductStatus = 101 and Type_id_ProductType = 323 and Product_id=0 and (Time_Start < '"+FormatTime(System.DateTime.Now)+"' and Time_Expired > '"+FormatTime(System.DateTime.Now)+"')";
